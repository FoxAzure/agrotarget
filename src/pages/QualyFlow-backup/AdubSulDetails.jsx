...
import HeaderAdubSul from '../../components/QualyFlow/HeaderAdubSul';
...
const AdubSulDetails = () => {
  ...
  // 1. GESTÃO DE DATAS
  // ===========================================================================
  const OCORRENCIAS = ["Implemento 2 linhas - Sulcamento", "Implemento 3 linhas - Sulcamento"];
  ...
  const adubData = useMemo(() => {
    ...
    dayData.forEach(item => {
      const idUnico = item.ADUBADOR_SULCO || item.DATA_HORA;
    ...
    const implementos = Object.entries(groups).map(([key, data]) => {
      ...
      // Ordem Fixa por Memória Muscular
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans pb-24 text-slate-900">
      <HeaderAdubSul onMenuOpen={() => setSidebarOpen(true)} />
      ...
      <main className="p-6 flex flex-col items-center gap-8">
        ...
        {adubData ? (
          <div className="w-full max-w-[400px] flex flex-col gap-8 animate-in fade-in duration-500">
            ...
            {/* CARDS DE TOPO (Padding P-6 Robusto) */}
                    ...
                    <div className={`grid transition-all duration-300 ${isExp ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                      <div className="overflow-hidden">
                        <div className="p-6 bg-white border-t border-slate-50">
                           <div className="flex justify-between border-b border-slate-100 pb-2 mb-4 items-end">
                           ...
                           <div className="flex flex-col">
                             {/* Conteúdo Slim e sem boxes arredondadas internas */}
